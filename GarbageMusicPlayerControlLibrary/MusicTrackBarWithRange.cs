...
{
    public partial class MusicTrackBarWithRange : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graphics.DrawLine(new Pen(Color.Black, 2.1f), leftEnd, rightEnd);
            graphics.DrawLine(new Pen(Color.Cyan, 2), leftEnd, currentCoord);
            graphics.DrawLine(new Pen(Color.White, 2), currentCoord, rightEnd);
